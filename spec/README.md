...
| `01-agent-team-requirements.md` | Agent runtime, local tool surface, implementation plan, development automation |
...
| `04-mac-and-mobile-apps.md` | Apps/local commands/remote control, architecture, development automation |
| `05-technical-stack.md` | Architecture, implementation plan, development automation |
